...
test.describe("Drag-und-Drop-Übungen", () => {
    test("should load dragdrop exercises list or redirect to login", async ({ page }) => {
    ...
    test("should show dragdrop links or empty state", async ({ page }) => {
        ...
        const exerciseLinks = page.locator('a[href*="/grammar/exercises/dragdrop/"]');
    ...
    test("should open a dragdrop exercise detail page when available", async ({ page }) => {
        test.setTimeout(60000);
