...
CREATE TRIGGER after_click_exercises_insert
  AFTER INSERT ON public.click_exercises
  FOR EACH ROW
...
ALTER TABLE public.click_answers
  ADD CONSTRAINT click_answers_click_exercise_id_fkey
    FOREIGN KEY (click_exercise_id) REFERENCES public.click_exercises(id) ON DELETE CASCADE;

ALTER TABLE public.click_answers
  ADD CONSTRAINT click_answers_click_exercise_id_target_words_fkey
    FOREIGN KEY (click_exercise_id, target_words)
    REFERENCES public.click_exercises(id, target_words)
...
ALTER TABLE public.click_to_exercises
  ADD CONSTRAINT click_to_exercises_click_id_fkey
    FOREIGN KEY (click_id) REFERENCES public.click_exercises(id);
...
ALTER TABLE public.dnd_user_answer
  ADD CONSTRAINT dnd_user_answer_category_id_fkey
    FOREIGN KEY (category_id) REFERENCES public.dnd_categories(id) ON DELETE CASCADE;
...
ALTER TABLE public.dnd_user_answer
  ADD CONSTRAINT dnd_user_answer_word_id_fkey
    FOREIGN KEY (word_id) REFERENCES public.draggable_words(id) ON DELETE CASCADE;
...
ALTER TABLE public.exercises_to_grammar_items
  ADD CONSTRAINT exercises_to_grammar_items_grammar_item_id_fkey
    FOREIGN KEY (grammar_item_id) REFERENCES public.grammar_items(id);
...
CREATE TABLE public.fillinthegap_exercises (
...
CREATE TRIGGER fillinthegap_exercises_updated_at
  BEFORE UPDATE ON public.fillinthegap_exercises
  FOR EACH ROW
  EXECUTE FUNCTION updated_at();

CREATE SEQUENCE public.fillinthegap_submissions_id_seq;

CREATE TABLE public.fillinthegap_submissions (
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  exercise_id bigint NOT NULL,
  user_id bigint NOT NULL,
...
CREATE TRIGGER fillinthegap_submissions_updated_at
  BEFORE UPDATE ON public.fillinthegap_submissions
  FOR EACH ROW
  EXECUTE FUNCTION updated_at();

ALTER SEQUENCE public.fillinthegap_submissions_id_seq OWNED BY public.fillinthegap_submissions.id;

ALTER TABLE public.fillinthegap_submissions
  ADD CONSTRAINT fillinthegap_submissions_exercise_id_fkey
    FOREIGN KEY (exercise_id) REFERENCES public.fillinthegap_exercises(id) ON DELETE CASCADE;

ALTER TABLE public.fillinthegap_submissions
  ADD CONSTRAINT fillinthegap_submissions_user_id_fkey
    FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
CREATE INDEX free_form_answers_free_form_exercise_id_idx
  ON public.free_form_answers USING btree (free_form_exercise_id);
...
ALTER TABLE public.free_form_answers
  ADD CONSTRAINT free_form_answers_free_form_exercise_id_fkey
    FOREIGN KEY (free_form_exercise_id) REFERENCES public.free_form_exercises(id) ON DELETE CASCADE;
...
CREATE TRIGGER update_glossary_entries_updated_at
  BEFORE UPDATE ON public.glossary_entries FOR EACH ROW EXECUTE FUNCTION updated_at();
...
ALTER TABLE public.multichoice_content
  ADD CONSTRAINT multichoice_content_multichoice_exercise_id_fkey
    FOREIGN KEY (multichoice_content_id) REFERENCES public.multichoice_exercises(id) ON DELETE CASCADE;
...
ALTER TABLE public.multichoice_options
  ADD CONSTRAINT multichoice_options_multichoice_content_id_fkey
    FOREIGN KEY (multichoice_content_id) REFERENCES public.multichoice_content(id) ON DELETE CASCADE;
...
ALTER TABLE public.part_questions
  ADD CONSTRAINT part_questions_form_part_id_fkey
    FOREIGN KEY (form_part_id) REFERENCES public.form_parts(id) ON DELETE RESTRICT;
...
ALTER TABLE public.user_question_answers
  ADD CONSTRAINT user_question_answers_part_question_id_fkey
    FOREIGN KEY (part_question_id) REFERENCES public.part_questions(id) ON DELETE RESTRICT;
ALTER TABLE public.user_question_answers
...
CREATE TRIGGER updated_at
  BEFORE UPDATE ON public.word_category_mappings FOR EACH ROW EXECUTE FUNCTION updated_at();
...
ALTER TABLE public.word_category_mappings
  ADD CONSTRAINT word_category_mappings_exercise_id_fkey
    FOREIGN KEY (exercise_id) REFERENCES public.dnd_exercises(id) ON DELETE CASCADE;
ALTER TABLE public.word_category_mappings
