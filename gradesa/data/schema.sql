...
CREATE TRIGGER fillinthegap_exercises_updated_at BEFORE UPDATE ON public.fillinthegap_exercises FOR EACH ROW EXECUTE FUNCTION updated_at();

CREATE SEQUENCE public.fillinthegap_submissions_id_seq;

CREATE TABLE public.fillinthegap_submissions (
  id bigint PRIMARY KEY NOT NULL DEFAULT nextval('fillinthegap_submissions_id_seq'::regclass),
  exercise_id bigint NOT NULL,
  user_id bigint NOT NULL,
...
CREATE TRIGGER fillinthegap_submissions_updated_at BEFORE UPDATE ON public.fillinthegap_submissions FOR EACH ROW EXECUTE FUNCTION updated_at();
...
FOREIGN KEY (exercise_id) REFERENCES fillinthegap_exercises(id) ON DELETE CASCADE;
