...
CREATE SEQUENCE public.grammar_pages_html_id_seq;

CREATE TABLE public.grammar_pages_html (
  id integer PRIMARY KEY NOT NULL DEFAULT nextval('grammar_pages_html_id_seq'::regclass),
  title text NOT NULL,
  slug text NOT NULL,
  content text NOT NULL
);

ALTER SEQUENCE public.grammar_pages_html_id_seq OWNED BY public.grammar_pages_html.id;
