...
export default function DndMatchExercisesPage() {
  ...
  const handleDelete = async (exerciseId) => {
    ...
    try {
      ...
      if (!response.ok) throw new Error("Fehler beim Löschen der Übung.");
      refetch();
    } catch {
        ...
        {exercises.map((exercise) => (
          ...
          >
            <Column flex="1">
              ...
              >
                <Link
                  href={`/grammar/exercises/dnd-match/${exercise.id}`}
            ...
            <Column gap="sm" align="flex-end">
              ...
              <Link
                href={`/admin/create-exercise/dnd-match/${exercise.id}/edit`}
              >
