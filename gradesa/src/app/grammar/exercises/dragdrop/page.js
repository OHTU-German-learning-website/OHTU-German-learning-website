...
export default function DragdropExercisesPage() {
    ...
    const handleDelete = async (exerciseId) => {
        ...
        try {
            const response = await fetch(`/api/admin/exercises/dragdrop/${exerciseId}`, {
                method: "DELETE",
            });
                ...
                {exercises.map((exercise) => (
                    ...
                    >
                        <Column flex="1">
                            ...
                            >
                                <Link
                                    href={`/grammar/exercises/dragdrop/${exercise.dnd_id}`}
                        ...
                        <Column gap="sm" align="flex-end">
                            ...
                            <Link
                                href={`/admin/create-exercise/dragdrop/${exercise.dnd_id}/edit`}
                            >
                            ...
                            <Button
                                ...
                                onClick={() => handleDelete(exercise.dnd_id)}
                            >
                                Löschen
                            </Button>
                        </Column>
